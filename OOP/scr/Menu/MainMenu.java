...
public class MainMenu {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Harry Potter", "B1", "J.K. Rowling", "Bloomsbury", 5, fiction);
        Book book2 = new Book("The Shining", "B2", "Stephen King", "Doubleday", 3, horror);

        library.getBooks().add(book1);
        library.getBooks().add(book2);

        Reader reader1 = new Reader("R1", "Alice","0123456789", "123 Wonderland");
        Reader reader2 = new Reader("R2", "Bob", "9876543210", "456 Nowhere");
